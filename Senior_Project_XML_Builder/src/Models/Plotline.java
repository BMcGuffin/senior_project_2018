...
{
	// FUTURE Add support for saving plotlines to their own files.
	/**
	 ...
	 * the plotline. Value: An instance. NOTE: All times are relative only to the
	 * start of this plotline; the value here is different from the absolute script
	 * time.
	 */
	 ...
	 *
	 * @param start
	 *            The start time, in seconds, of this plotline.
	 * @param parentScript
	 *            The script to which this plotline belongs.
	 */
	...
	/**
	 * Add an instance to this plotline. Doesn't overwrite existing instance at the
	 * given time.
	 *
	 * @param time
	 *            the time, in seconds, of the new instance, relative to the
	 *            beginning of the plotline
	 * @return the instance that exists at the given time, or a new instance if one
	 ...
	 *
	 * @param time
	 *            the time, in seconds, of the instance to be removed, relative to
	 *            the beginning of the plotline
	 ...
	 *
	 * @param from
	 *            the current time of the instance to be moved.
	 * @param to
	 ...
	 *
	 * @param time
	 *            The amount of seconds into the plotline that this instance occurs.
	 * @return the instance in question, or null if no instance exists at that time.
	 */

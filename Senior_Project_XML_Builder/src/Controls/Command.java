...
public enum Command
{
    ...
    REMOVE_PLOTLINE,
    /**
     * Deprecated. Print the script to a file using the toXML method. Args
     * should be empty.
     */
    //PRINT,
    /**
     * Load a new script from a file. Args should contain the path to the new
     * file.
     */
    LOAD_FILE,
    /**
    ...
    CHANGE_SCRIPT_TITLE,
    /**
     * Change the title of a plotline. Args should contain the index of the
     * plotline to be renamed, and the new title.
     */
    ...
    ADD_EVENT,
    /**
     * Move an event from one part of the plotline to another. Args should
     * include the index of the plotline to be changed, the current time of the
     * event, the index of the event at that time, and the new time for the
     * event.
     */
    RELOCATE_EVENT,
    /**
     * Remove an event from the plotline. Args should include the index of the
     * plotline to be changed, the time of the event, and the index of the event
     * at that time.
     */
    REMOVE_EVENT,
    /**
    ...
    /**
     * Change the description of a plotline. Args should contain the index of
     * the plotline to be changed, and the new description.
     */
    CHANGE_PLOTLINE_DESCRIPTION,
    /**
     * Change the start time of a plotline. Args should contain the index of the
     * plotline to be changed, and the number of seconds into the script that
     * the plotline should start.
     */

...
public enum Command
{
	...
	/************************************************************************************/
	/**
	 * Change the title of the current plotline. Args should contain the new title.
	 */
	CHANGE_PLOTLINE_TITLE,
	/**
	 * Add a new event to this plotline. Args should include the time to add the
	 * event at, and the type of event.
	 */
	ADD_EVENT,
	/**
	 * Move an event from one part of the plotline to another. Args should include
	 * the index of the event at the current time, and the new time for the event.
	 */
	RELOCATE_EVENT,
	/**
	...
	REMOVE_EVENT,
	/**
	 * Change the description of a plotline. Args should contain the new
	 * description.
	 */
	CHANGE_PLOTLINE_DESCRIPTION,
	/**
	 * Change the start time of a plotline. Args should contain the number of
	 * seconds into the script that the plotline should start.
	 */
	...
	/************************************************************************************/
	/**
	 * Replace the text in a text field in an event. Args should contain the new
	 * text.
	 */
